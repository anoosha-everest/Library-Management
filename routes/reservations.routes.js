...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, reservations_1.reservations.findByPk(req.params.id)];
            case 1:
                reservation = _a.sent();
                if (reservation === null) {
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, reservations_1.reservations.create(req.body)];
            case 1:
                reservation = _a.sent();
                res.json(reservation);
                return [3 /*break*/, 3];
...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, reservations_1.reservations.update(req.body, { where: { id: req.params.id } })];
            case 1:
                updated = (_a.sent())[0];
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, reservations_1.reservations.destroy({ where: { id: req.params.id } })];
            case 1:
                deleted = _a.sent();
                if (deleted) {
