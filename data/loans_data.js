...
exports.insertLoans = void 0;
var loans_1 = require("../Models/loans");
var insertLoans = function () { return __awaiter(void 0, void 0, void 0, function () {
    var loan, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, loans_1.loans.bulkCreate([
            ...
            case 2:
                err_1 = _a.sent();
                console.error("Error inserting loans:", err_1);
